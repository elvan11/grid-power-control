...
export interface PlantSharingRemoveMemberDeps {
...
export function createPlantSharingRemoveMemberHandler(
  deps: PlantSharingRemoveMemberDeps,
) {
  return async (req: Request): Promise<Response> => {
    ...
    try {
      ...
      const body = await deps.readJson<RemoveMemberPayload>(req);
